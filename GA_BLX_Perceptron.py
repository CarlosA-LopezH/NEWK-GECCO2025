...
def main(ds_name: str, id_method: str, id_run: str, n_workers: int) -> tuple[float, float, int, float]:
    ...
    net_size: tuple = 20 # Number of neurons in the liquid.
    # ---- DEAP Framework:
...
if __name__ == '__main__':
    main(ds_name='FR5_small', id_method="GA_BLX_Perceptron-GECCO2025_All", id_run="1",
         n_workers=cpu_count() - 2)
    # method = "GA_BLX_Perceptron-MCA2025"
    # evo, val, evals, times = [], [], [], []
    # cpu_prct = psutil.cpu_percent()
    # print(cpu_prct)
    # mem = psutil.virtual_memory()
    # print(mem)
    # evo_acc, val_acc, t_evals, t_times = main(ds_name='FR5_small', id_method=f"Debugging", id_run=f"{0}",
    #                                                   n_workers=cpu_count() - 2)
    # cpu_prct = psutil.cpu_percent()
    # print(cpu_prct)
    # mem = psutil.virtual_memory()
